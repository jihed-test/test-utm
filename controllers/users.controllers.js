...
const ValidateRegister1 = require("../validation/Register1");
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="esd-block-text es-p5t es-p10b es-p15r es-p15l" align="right">
                                                                                                    ...
                                                                                                    <h2 style="line-height: 120%; color: #de4a4a;"><strong>${output}</strong></h2>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="esd-block-text es-m-txt-c es-p15t" align="center">
                                                                                                    ...
                                                                                                    <p style="color: #dbdbdb; font-size: 16px;">Please enter the code ${output} to verify your account.</p>
